...
@Module({
  ...
  providers: [AuthService, JwtStrategy], // use this service to handle the business logic related to authentication, such as registering new users, validating credentials, and generating JWT tokens. The JwtStrategy is used to define how JWT tokens should be validated and how user information should be extracted from the token.
