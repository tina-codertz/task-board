...
export default function ManagerTaskDetailScreen() {
    ...
    >
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.infoSection}>
            ...
            {task.assignedTo && (
              <View style={styles.infoRow}>
                ...
                <Text style={styles.infoText}>Assigned to: {task.assignedTo.name}</Text>
              </View>
            )}
            {task.team && (
              <View style={styles.infoRow}>
                <MaterialCommunityIcons name="account-multiple" size={16} color="#666" />
                <Text style={styles.infoText}>Team: {task.team.name}</Text>
              </View>
            )}
            <View style={styles.infoRow}>
        ...
        <View style={styles.commentsSection}>
          <Text style={styles.sectionTitle}>Team Comments ({comments.length})</Text>
